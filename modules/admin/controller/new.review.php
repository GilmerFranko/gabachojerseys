...
if (isset($_POST['save']))
{
  ...
  $image_url = cleanString($_POST['image_url'] ?? '');

  $msg = [];

  if (empty($customer_name)) $msg[] = 'El nombre del cliente no puede estar vacío.';
  if (empty($comment))       $msg[] = 'El comentario no puede estar vacío.';
